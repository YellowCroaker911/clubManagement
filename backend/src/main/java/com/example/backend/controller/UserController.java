...
public class UserController {
    ...
    public ResultData<Object> alterInfo(@RequestBody @Validated UserAlterInfoRequestDTO userAlterInfoRequestDTO) {
        return userService.userAlterInfo(
                userAlterInfoRequestDTO.getName(),
                userAlterInfoRequestDTO.getGender(),
                        userAlterInfoRequestDTO.getPhone(), userAlterInfoRequestDTO.getEmail());
    }
    ...
    public ResultData<User> getInfo() {
        User user = userService.userGetInfo();
...
//            folder.mkdirs();
//        }
        String avatar = userService.userGetInfo().getAvatar();
